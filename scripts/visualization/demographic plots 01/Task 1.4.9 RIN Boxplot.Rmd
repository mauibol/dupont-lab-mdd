...
```{r}
p_box_rin = ggplot(ST1, aes(x = Group, y = RIN, fill = Group, color = Group)) +
  ...
  annotate("text", x = 1, y = 8.5, label="atop(bolditalic('Wilcoxon p'==0.04), bolditalic('n'==38))", parse = TRUE) +
...
```{r}
ggsave("final_graph/boxplot_RIN MDD vs CTRL.pdf", p_box_rin, dpi = 72, width = 4, height = 4)
```
